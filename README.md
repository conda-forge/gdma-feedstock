...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gdma-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gdma-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gdma pygdma
# for installing globally
pixi global install gdma pygdma
```
...
It is possible to list all of the versions of `gdma` available on your platform:
...
```
pixi search gdma --channel conda-forge
```
